package com.huanxin.workspace.feature.video.tpnspush;
...
public class TPNSPushSetting implements PushSettingInterface {
    ...
    public void init() {
        ...
        XGPushConfig.enablePullUpOtherApp(MyApplication.getApplication(), false);
    ...
    @Override
    public void unInit() {
        XGPushManager.unregisterPush(MyApplication.getApplication(),
    ...
    public void bindUserID(String userId) {
        ...
        XGPushManager.upsertAccounts(MyApplication.getApplication(), Arrays.asList(accountInfo),
                new XGIOperateCallback() {
                    @Override
    ...
    public void unBindUserID(String userId) {
        ...
        XGPushManager.delAccounts(MyApplication.getApplication(), accountTypeSet, xgiOperateCallback);
    }
    ...
    private void prepareTPNSRegister() {
        ...
        XGPushConfig.setMiPushAppId(context, "2882303761520149280");
        XGPushConfig.setMiPushAppKey(context, "5232014988280");
        // 注意这里填入的是 Oppo 的 AppKey，不是AppId
        XGPushConfig.setOppoPushAppId(context, "6c7391d6279642de9653a6091eb20074");
        // 注意这里填入的是 Oppo 的 AppSecret，不是 AppKey
        XGPushConfig.setOppoPushAppKey(context, "6b1f1eb0068c47e79ac5cf3e1218a2a4");
        // 重要：开启厂商通道注册
