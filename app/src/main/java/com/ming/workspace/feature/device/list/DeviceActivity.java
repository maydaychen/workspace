...
import static com.ming.workspace.Consts.RC_CAMERA_CONTACTS_PERM;
...
import com.ming.workspace.data.BindedDeviceBean;
import com.ming.workspace.data.UserBean;
import com.ming.workspace.feature.device.BindRecordAdapter;
import com.ming.workspace.feature.device.bind.DeviceBindActivity;
import com.ming.workspace.widget.CustomTitleBar;
    ...
    public void onViewClicked(View view) {
        if (view.getId() == R.id.btn_scan) {
            if (checkSelfPermission(CAMERA) != PackageManager.PERMISSION_GRANTED) {
                requestPermissions(new String[]{CAMERA}, RC_CAMERA_CONTACTS_PERM);
            } else {
                init();
            }
        }
